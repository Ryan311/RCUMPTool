...
EXTERN RT_VOID ListInitializeHeader(PRT_LIST_HEAD ListHead);
...
*/
EXTERN RT_VOID ListAddToHead(PRT_LIST_ENTRY ListNew, PRT_LIST_HEAD ListHead);
...
*/
EXTERN RT_VOID ListAddToTail(PRT_LIST_ENTRY ListNew, PRT_LIST_HEAD ListHead);
...
*/
EXTERN RT_LIST_ENTRY* ListGetTop(PRT_LIST_HEAD ListHead);
...
*/
EXTERN RT_VOID ListDeleteNode(PRT_LIST_ENTRY ListToDelete);

/**
    Tell whether the list is empty
    \param [IN] ListHead          <RT_LIST_ENTRY>                 : List header of which to be test
*/
EXTERN RT_BOOL ListIsEmpty(PRT_LIST_HEAD ListHead);

//EXTERN RT_VOID ListEmpty(PRT_LIST_HEAD ListHead);
...
*/
#define LIST_ENTRY(_Ptr, _Type, _Field) ((_Type *)( \
                          (PRT_U8)(_Ptr) - \
                          (ULONG_PTR)(&((_Type *)0)->_Field)))

...
/*
/*	Name:	      SplitterControl.cpp
/*  Function:     The class using Implement splitter control for dialog
/*			      and resizing the size of View.
/*  
/*  Author:       lava_sdb
...
#include "stdafx.h"
//#include "MyDlg.h"    //View public the DisplayView
//#include "MyDlgDlg.h"	 //View public the DisplayView
...
void CSplitterControl::AddView(UINT docNum, UINT viewNum,
							   UINT type,CView *pView)
{
	/**********************************/
	//this will modify you Dialog Class
	CMyDlgDlg *dlg=(CMyDlgDlg *)this->GetParent();
	
	dlg->AddView(docNum,viewNum,type,this,pView);
}

BOOL CSplitterControl::AddRootView(UINT docNum, UINT viewNum, CRect rect)
{
	...
	if((m_pLView=dlg->AddRootView(docNum,viewNum,rect,this))!=NULL)
	{
		//CString temp=typeid(*m_pLView).name();
		//ASSERT(temp.Find("CView",1)<0);		
		return true;		
	}
	return false;
}

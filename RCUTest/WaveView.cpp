...
{  
...

	{
		CFileException fe;
		CFile pFile;
		pFile.Open(pDoc->GetPathName(), CFile::modeRead | CFile::shareDenyWrite,&fe);
		CArchive loadArchive(&pFile,CArchive::load);
		//loadArchive.m_pDocument=this;
		loadArchive.m_bForceFlat=FALSE;
		CWaitCursor wait;
		if(pFile.GetLength() > 44)
		{

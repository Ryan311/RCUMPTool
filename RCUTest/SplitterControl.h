...
public:
	...
	CRect m_rect0;					//left or top rect
	CRect m_rect1;					//right or bottom rect

	CView *m_pLView;				//left or top view
	CView *m_pRView;				//right or bottom view

	CSplitterControl *m_pSplit0;     //left or top split
	CSplitterControl *m_pSplit1;     //right or bottom split
// Attributes
public:
...
public:
	BOOL AddRootView(UINT docNum,UINT viewNum,CRect rect);
	void AddView(UINT docNum, UINT viewNum,UINT type,CView *pView);
